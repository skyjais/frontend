...
// const WelcomeScreens: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
    ...
    <div className="welcome-container">
      ...
      {screen === 1 && (
       ...
       <img src="../assets/mon.svg" alt="" />
          ...
          <button onClick={nextScreen}> <img src="../assets/startbutton.svg"    /></button>
        </div>
      )}
      {screen === 2 && (
        <div className="welcome-screen2">

          <button className="nav-button" onClick={prevScreen}> <img src="../assets/back.svg" alt=""  /> </button>
          <div className="mondiv2">
       <img src="../assets/mon.svg" alt="" />
       </div>
          <div className="image-container2">
          <img src="../assets/helocloud.svg" alt="Monkey" />
          <h1>Hi, I am Mizzo ! <br /> and I love bananas</h1>
          </div>
          
          <div className="nextbtn">
          <button onClick={nextScreen}> <img src="../assets/next.svg"    /></button>
          </div>
      ...
      {screen === 3 && (
       ...
       <div className="image-container2">
       <img src="../assets/helocloud.svg" alt="Monkey" />
          <h1>Can you help me to <br /> get some ?</h1>
          
          </div>

          <div className="nextbtn">
          <button onClick={nextScreen}> <img src="../assets/Yes.svg"/>  </button>
          </div>
        </div>
      )}
      {screen === 4 && (
...
<div className="card-container-o">
      <div className="card-o">
        <div className="image-container-o">
          <img src="../assets/card.svg" alt="Pink Card" className="card-image-o"/>
      ...
      <div className="card-o">
        <div className="image-container-o">
          <img src="../assets/bcard.svg" alt="Pink Card" className="card-image-o"/>
          {/* <img src="../assets/card1.svg" alt="Apple" className="apple-image"/> */}
        </div>
        <div className="card-content-o">
          <div className="step-number">
      ...
      <div className="card-o">
        ...
        <div className="card-content-o">
          ...
          <button onClick={onComplete}><img src="../assets/play.svg"/></button>
          </div>
